      ...
      <div className="w-full max-w-3xl bg-base-200 shadow-xl hover:shadow-2xl rounded-3xl p-6 md:p-8">
        ...
        <ul className="space-y-3 text-lg px-4 sm:px-6">
          <li className="flex items-start gap-2">
            <span>🤖</span>
            <span>
              <strong>Interactive AI Chat:</strong> Engage with our smart assistant to create entries effortlessly. It guides your reflection and records the chat, making journaling faster and more interactive.
            </span>
            </li>
          <li className="flex items-start gap-2">
            <span>✅</span>
