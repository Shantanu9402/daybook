// In frontend/src/components/entry/EntryCard.jsx
...
const EntryCard = ({
  ...
  date,
  title,
  mood, // The mood prop is still here, we just won't display it
  content,
  updatedAt,
  highlightText,
}) => {
  ...
  return (
    <div className="card bg-base-200 w-100 h-auto shadow-xl hover:shadow-2xl rounded-3xl">
